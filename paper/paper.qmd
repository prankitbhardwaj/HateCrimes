...
The dataset used in this analysis is sourced from [Open Data Toronto](https://open.toronto.ca/dataset/hate-crimes-open-data/), specifically from the Toronto Police Service's verified hate crime occurrences. It includes all confirmed hate crimes investigated by the Hate Crime Unit from 2018 onwards. The dataset provides valuable information to enhance public safety and awareness about hate crimes in Toronto.
...
Figure
 ...
 \@ref(fig-bias-motivation) illustrates the distribution of hate crimes by bias motivation...
